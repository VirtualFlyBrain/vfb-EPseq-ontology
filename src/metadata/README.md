 ...
 * [VFB_EPseq.yml](VFB_EPseq.yml)
     * Determines how your purl.obolibrary.org/obo/VFB_EPseq/ redirects will be handled
     ...
     * Paste in the contents of [VFB_EPseq.yml](VFB_EPseq.yml)
 ...
 * [VFB_EPseq.md](VFB_EPseq.md)
     ...
     * Paste in the contents of [VFB_EPseq.md](VFB_EPseq.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
